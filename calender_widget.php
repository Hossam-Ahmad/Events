<? $page="web_integrations_calender";
   $login=1;
   include ('lang/en.php'); 
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="templates/calender/main.css">
...
<body>
    ...
    <!-- App -->
    <main id="app">
        <? include('content/calender_widget.php'); ?>
    </main>
    <!-- Footer -->
    ...
    <script>
        ...
        $('[data-toggle="generate"]').click(function () {
            var target = $(this).data('target'),
                height = $('.widget-calender').outerHeight(),
                width = $('.widget-calender').outerWidth(),
                link = $(this).data('link'),
